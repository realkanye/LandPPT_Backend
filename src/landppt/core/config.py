...
class AIConfig(BaseSettings):
    ...
    parallel_slides_count: int = Field(default=1, env="PARALLEL_SLIDES_COUNT")
...
class AppConfig(BaseSettings):
    ...
    api_only_mode: bool = Field(default=False, env="API_ONLY_MODE")
    anonymous_user_id: int = Field(default=1, env="ANONYMOUS_USER_ID")
